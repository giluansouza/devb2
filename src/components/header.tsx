...
export function Header() {
  return (
    <header className="w-full flex justify-center py-6 px-2">
      <div className="w-full max-w-7xl flex items-center bg-zinc-900/40 justify-center gap-2 md:justify-between border-b px-3 md:px-6 py-2 rounded-full border border-zinc-500 shadow-xl">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          >
            <Button variant="outline" className="rounded-full w-20 shadow-lg">
              <Instagram color="white" className="w-5 h-5" />
            </Button>
          </Link>
        </div>
      </div>
